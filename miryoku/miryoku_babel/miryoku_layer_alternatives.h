...
U_MTC(LGUI, Q),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MTS(LSHFT, F),    &kp G,             &kp H,             U_MTS(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MTC(LGUI, M),     \
...
U_MTC(LGUI, Y),     U_MT(LALT, I),     U_MT(LCTRL, E),    U_MTS(LSHFT, A),    &kp DOT,           &kp D,             U_MTS(LSHFT, S),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MTC(LGUI, B),     \
...
U_MTC(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MTS(LSHFT, T),    &kp D,             &kp H,             U_MTS(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MTC(LGUI, O),     \
...
U_MTC(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MTS(LSHFT, T),    &kp G,             &kp M,             U_MTS(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MTC(LGUI, O),     \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MTC(LGUI, A),     U_MT(LALT, R),     U_MT(LCTRL, S),    U_MTS(LSHFT, T),    &kp G,             &kp K,             U_MTS(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, I),     U_MTC(LGUI, O),     \
...
U_MTC(LGUI, A),     U_MT(LALT, O),     U_MT(LCTRL, E),    U_MTS(LSHFT, U),    &kp I,             &kp D,             U_MTS(LSHFT, H),    U_MT(LCTRL, T),    U_MT(LALT, N),     U_MTC(LGUI, S),     \
...
U_MTC(LGUI, S),     U_MT(LALT, H),     U_MT(LCTRL, N),    U_MTS(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MTS(LSHFT, A),    U_MT(LCTRL, E),    U_MT(LALT, O),     U_MTC(LGUI, I),     \
...
U_MTC(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, H),    U_MTS(LSHFT, T),    &kp G,             &kp Y,             U_MTS(LSHFT, N),    U_MT(LCTRL, E),    U_MT(LALT, O),     U_MTC(LGUI, I),     \
...
U_MTC(LGUI, A),     U_MT(LALT, S),     U_MTS(LCTRL, D),    U_MTS(LSHFT, F),    &kp G,             &kp H,             U_MTS(LSHFT, J),    U_MTSR(LCTRL, K),    U_MT(LALT, L),     U_MTC(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MTC(LGUI, A),     U_MT(LALT, S),     U_MT(LCTRL, D),    U_MTS(LSHFT, F),    &kp G,             &kp H,             U_MTS(LSHFT, J),    U_MT(LCTRL, K),    U_MT(LALT, L),     U_MTC(LGUI, SQT),   \
...
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_MTC(LGUI, A),     U_MT(LALT, S),     U_MTS(LCTRL, D),    U_MTS(LSHFT, F),    &kp G,             &kp H,             U_MTSR(LSHFT, J),    U_MTSR(LCTRL, K),    U_MT(LALT, L),     U_MTC(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
...
&kp A,             &kp S,             &kp D,             &kp F,             &kp G,             &kp H,             &kp J,             &kp K,             &kp L,             &kp SQT,           \
&kp Z,             &kp X,             &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH,         \
U_NP,              U_NP,              &kp TAB,           &kp BSPC,         &kp DEL,           &kp RET,           &kp SPACE,          &kp ESC,           U_NP,              U_NP
...
U_NA,              &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              &kp INS,           &kp HOME,          &kp PG_UP,         &kp PG_DN,         &kp END,           \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              U_NU,              U_MS_L,            U_MS_U,            U_MS_D,            U_MS_R,            \
U_NA,              &kp RALT,          &u_to_U_SYM,       &u_to_U_MOUSE,     U_NA,              U_NU,              U_WH_L,            U_WH_U,            U_WH_D,            U_WH_R,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_BTN2,            U_BTN1,            U_BTN3,            U_NP,              U_NP
...
U_UND,             &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NU,              U_NU,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
